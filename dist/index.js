...
server.tool("read_docx", {
    ...
    try {
        ...
        return {
            content: [{ type: "text", text: `读取 DOCX 失败: ${message}` }],
            isError: true,
        };
    }
});
server.tool("write_docx", {
    ...
    try {
        ...
        const message = err instanceof Error ? err.message : String(err);
        return {
            content: [{ type: "text", text: `写入 DOCX 失败: ${message}` }],
            isError: true,
        };
    }
});
...
server.tool("read_pdf", {
    ...
    try {
        ...
        const message = err instanceof Error ? err.message : String(err);
        return {
            content: [{ type: "text", text: `读取 PDF 失败: ${message}` }],
            isError: true,
        };
    }
});
server.tool("write_pdf", {
    ...
    try {
        ...
        const message = err instanceof Error ? err.message : String(err);
        return {
            content: [{ type: "text", text: `写入 PDF 失败: ${message}` }],
            isError: true,
        };
    }
});
...
server.tool("read_excel", {
    ...
    try {
        ...
        const message = err instanceof Error ? err.message : String(err);
        return {
            content: [{ type: "text", text: `读取 Excel 失败: ${message}` }],
            isError: true,
        };
    }
});
server.tool("write_excel", {
    ...
    try {
        ...
        const message = err instanceof Error ? err.message : String(err);
        return {
            content: [{ type: "text", text: `写入 Excel 失败: ${message}` }],
            isError: true,
        };
    }
});
