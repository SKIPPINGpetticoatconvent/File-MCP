...
server.tool(
  ...
  async ({ file_path }) => {
    try {
      ...
      return {
        content: [{ type: "text" as const, text: `读取文本文件失败: ${message}` }],
        isError: true,
      };
    }
  }
...
server.tool(
  ...
  async ({ file_path, content }) => {
    try {
      ...
      const message = err instanceof Error ? err.message : String(err);
      return {
        content: [{ type: "text" as const, text: `写入文本文件失败: ${message}` }],
        isError: true,
      };
    }
  }
...
server.tool(
  ...
  async ({ file_path }) => {
    try {
      ...
      const message = err instanceof Error ? err.message : String(err);
      return {
        content: [{ type: "text" as const, text: `读取 JSON 失败: ${message}` }],
        isError: true,
      };
    }
  }
...
server.tool(
  ...
  async ({ file_path, data }) => {
    try {
      ...
      const message = err instanceof Error ? err.message : String(err);
      return {
        content: [{ type: "text" as const, text: `写入 JSON 失败: ${message}` }],
        isError: true,
      };
    }
  }
...
server.tool(
  ...
  async ({ file_path }) => {
    try {
      ...
      const message = err instanceof Error ? err.message : String(err);
      return {
        content: [{ type: "text" as const, text: `读取 CSV 失败: ${message}` }],
        isError: true,
      };
    }
  }
...
server.tool(
  ...
  async ({ file_path, data }) => {
    try {
      ...
      const message = err instanceof Error ? err.message : String(err);
      return {
        content: [{ type: "text" as const, text: `写入 CSV 失败: ${message}` }],
        isError: true,
      };
    }
  }
...
server.tool(
  ...
  async ({ file_path }) => {
    try {
      ...
      const message = err instanceof Error ? err.message : String(err);
      return {
        content: [{ type: "text" as const, text: `读取 PPT 失败: ${message}` }],
        isError: true,
      };
    }
  }
...
server.tool(
  ...
  async ({ file_path, content }) => {
    try {
      ...
      const message = err instanceof Error ? err.message : String(err);
      return {
        content: [{ type: "text" as const, text: `写入 PPT 失败: ${message}` }],
        isError: true,
      };
    }
  }
